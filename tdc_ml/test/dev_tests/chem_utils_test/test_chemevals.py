...
class TestEvals(unittest.TestCase):
    ...
    def __init__(self, methodName='runTest'):
        ...
        self.smi_long = [
            ...
            "C#N", "O=C=O", "ClCCl", "BrCBr", "F", "Cl", "Br",
            "c1ccccc1C(=O)O", "c1ccccc1C(=O)N", "c1ccccc1C#N", "c1ccccc1S",
            "c1ccccc1CO", "c1ccccc1CN", "c1ccccc1OC", "c1ccccc1NC",
            "c1ccccc1NO", "c1ccccc1CCO", "CC(C)C(C)(C)C", "CC(C)OC(=O)C",
            "CNC(C)C", "CN(C)C(=O)C", "CC(C)CC(=O)O", "C(C(=O)O)(N)CC",
            "CC(C)C(=O)O", "CC(C)CO", "CC(C)CN", "CC(C)Cl", "OC(=O)c1ccccc1",
            "OC(=O)c1ccncc1", "OC(=O)c1ccc(Cl)cc1", "CC(=O)OC1=CC=CC=C1C(=O)O",
            "CC(C)COC(=O)C", "COC1=CC=CC=C1OC", "COC1=CC=CC=C1",
            "CN1CCCC1C(=O)O", "CC1=CC=CC=C1O", "C1=CC=C(C=C1)C(=O)O",
            "O=C(C)Oc1ccccc1C(=O)O", "O=C(NC)C", "O=C(NCc1ccccc1)C", "CC(C)CC",
            "CC1=CC=CN=C1", "C1=CN=CN1", "CC1=NC=CC=C1", "CC1=CC=C(O)C=C1",
            "COC(=O)C", "COC(=O)OC", "CCN(CC)C(=O)C", "CC(C)C(=O)N", "CC(C)CC",
            ...
            "C(C(C(=O)O)N)CO", "CC(C)C(=O)O", "CC(C)(C)C(=O)O",
            "CCCCCCCC(=O)O", "CCCCCCCCCCCC(=O)O", "CCCCCCCCCCCCCCCC(=O)O"
        ]
