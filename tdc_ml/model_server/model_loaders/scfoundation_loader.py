...
class scFoundationLoader:
    ...
    def load(self, checkpoint_path=None):
        canonical_path = os.path.join(self.DEFAULT_SAVE_DIR,
        ...
        print(
            "scFoundation checkpoint not found locally. Downloading from Google Drive..."
        )
    ...
    def _download_from_gdrive(self, output_path):
        ...
        print(
            f"scFoundation checkpoint saved to {output_path} ({size / 1024**2:.0f}MB)"
        )
        return output_path
